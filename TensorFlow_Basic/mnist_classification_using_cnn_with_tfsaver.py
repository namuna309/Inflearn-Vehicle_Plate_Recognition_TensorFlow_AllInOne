...
# tf.train.CheckpointManager를 이용해서 파라미터 저장
SAVE_DIR = "./model"
...
while int(ckpt.step) < (10000 + 1):
    ...
    # 100 Step 마다 training 데이터셋에 대한 정확도를 출력하고, tf.train.CheckpointManager를 이용해서 파라미터 저장
    if ckpt.step % 100 == 0:
